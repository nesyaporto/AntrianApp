...
public class Adapter_ReqBimDos extends RecyclerView.Adapter<Adapter_ReqBimDos.MyViewHolder> {
    ...
    public Adapter_ReqBimDos(Context context, ArrayList<Helper_ReqBim> list) {
