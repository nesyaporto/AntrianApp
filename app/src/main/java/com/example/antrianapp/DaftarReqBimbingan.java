...
//list bimbingan dosen
public class DaftarReqBimbingan extends AppCompatActivity {

    RecyclerView recyclerView;
    DatabaseReference db;
    Adapter_ListBimDos myAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_req_bim_dos);
        ...
        list = new ArrayList<>();
        myAdapter = new Adapter_ListBimDos(this, list);
        ...
        Query cekUser = db.orderByChild("id_mhs");
        cekUser.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (f.equals("Terima") & (c.equals(nomornya))) {
        ...
        public boolean onOptionsItemSelected (@NonNull MenuItem item){
            ...
            if (id == R.id.riwayat) {
                Intent i = new Intent(DaftarReqBimbingan.this, RiwayatBimDos.class);
                startActivity(i);
                return true;
            }
