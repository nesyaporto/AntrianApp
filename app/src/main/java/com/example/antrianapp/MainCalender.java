...
public class MainCalender extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_main_cal);
        CalendarView calendarView = findViewById(R.id.Kalender);
        recyclerView = findViewById(R.id.calendarRecyclerView);
        tambah_info = findViewById(R.id.tambah_info);
        ...
        tambah_info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainCalender.this, EventCalender.class);
